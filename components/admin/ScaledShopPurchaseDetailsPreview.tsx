...
interface ScaledShopPurchaseDetailsPreviewProps {
  details: DBShopPurchaseDetails;
}

export default function ScaledShopPurchaseDetailsPreview({
  details,
}: ScaledShopPurchaseDetailsPreviewProps) {
  ...
  return (
    <div ref={frameRef} className="relative w-full overflow-hidden">
      ...
      >
        ...
        >
          <ShopPurchaseDetailsSection animate={false} details={details} />
        </div>
      </div>
    </div>
  );
